  ...
  return (
    <div className='w-full flex flex-col items-center justify-center relative'>
      <footer className='footer p-10 '>
        <nav>
          <h6 className='footer-title'>Explore skillsmaster</h6>
        ...
        <form>
          ...
          <fieldset className='form-control w-80'>
            ...
            <div className='join'>
              <input
                type='text'
                placeholder='mohdshoaib91530@gmail.com'
                className='input input-bordered join-item text-white text-xs bg-gray-500'
              />
